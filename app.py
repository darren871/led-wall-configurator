...
try:
    config_parts = [
        ...
        str(final_is_horizontal), str(final_strategy), str(rigging),
        str(use_bu), str(voltage), str(cable_type), 
        str(distro_phase), str(distro_amps)
    ]
    current_config_str = "_".join(config_parts)
except NameError:
